...
<div class="koda">
<input id="koda" type="text" id="koda_question" name="koda_question" placeholder="Submit a question here or just click the button">
xref:{articles}/guide/quick-start#["Ask documentation",role="button secondary water"]
</div>
</p>
</div>
++++
